...
'''
Using FNO model here
'''
from ..figconvnet.multi_grid_convnet import FIGConvUNet

from ..figconvnet.geometries import (
    GridFeaturesMemoryFormat,
)

from ..figconvnet.components.reductions import REDUCTION_TYPES

from ..utils.visualization import fig_to_numpy
from ..utils.eval_funcs import eval_all_metrics

'''
This model is in usage
'''
class FIGConvUNetDrivAerNet_multi_grid(FIGConvUNet):
...
class FIGConvUNetDrivAerML_vt(FIGConvUNet):
    """FIGConvUNetDrivAerNet
