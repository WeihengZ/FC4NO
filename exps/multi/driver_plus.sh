...
#SBATCH --job-name=driver_plus_multi
#SBATCH --output="exps/multi/driver_plus_multi.out"
...
apptainer run --nv --writable-tmpfs \
            ...
            modulus.sif\
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python mainVT.py --model='multi' --data='driver_plus'"
