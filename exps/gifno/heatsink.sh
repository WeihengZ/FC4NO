...
#SBATCH --job-name=heatsink_gifno
#SBATCH --output="exps/gifno/heatsink_gifno.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python main.py --model='gifno' --data='heatsink'"
