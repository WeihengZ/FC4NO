...
#SBATCH --job-name=driver_plus_gifno
#SBATCH --output="exps/gifno/driver_plus_gifno.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python main.py --model='gifno' --data='driver_plus'"
