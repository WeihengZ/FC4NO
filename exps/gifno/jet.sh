...
#SBATCH --job-name=jet_gifno
#SBATCH --output="exps/gifno/jet_gifno.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python main.py --model='gifno' --data='jet'"
