...
#SBATCH --job-name=elastic_figconv
#SBATCH --output="exps/figconv/elastic_figconv.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python main.py --model='figconv' --data='elastic'"
