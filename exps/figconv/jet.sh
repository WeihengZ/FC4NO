...
#SBATCH --job-name=jet_figconv
#SBATCH --output="exps/figconv/jet_figconv.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python mainVT.py --model='figconv' --data='JEB'"
