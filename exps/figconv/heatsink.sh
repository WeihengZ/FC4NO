...
#SBATCH --job-name=heatsink_figconv
#SBATCH --output="exps/figconv/heatsink_figconv.out"
...
apptainer run --nv --writable-tmpfs \
    ...
    modulus.sif \
    bash -c "cd /FC && echo 'job is starting on \$(hostname)' && python --version && python main.py --model='figconv' --data='heatsink'"
